...
> 그 전에 [Git 그냥 일단 시작해보기 (GitHub)](/2019/06/dev-git-그냥-일단-시작해보기-github/) 를 보면서  
...
---
꽤 많은 내용을 다룬 것 같지만 활용에 관한 부분은 거의 다루지 않았다.  
(저장소 내부 구조 및 요소 설명이라던지, 브랜치, 명령어 설명 등..)

필요한 것들은 다음 글에서 다룰 것이지만,  
이 글 이상으로 이론적인 부분을 다루는 것 보다  
활용에 관한 부분을 다루게 될 것 같다.
